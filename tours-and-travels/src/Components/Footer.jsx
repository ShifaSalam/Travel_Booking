...
function Footer() {
  return (
    <>
      <footer className='footer bg-light shadow'>
        <Container>
          <Row>
            <Col lg='3'>
              <div className="">
                ...
                <p style={{ textAlign: 'justify' }}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatibus culpa nihil animi repellat, eaque commodi nisi blanditiis.</p>
            ...
            <Col lg='3' className='p-5'>
              ...
              <ListGroup className=''>
                ...
                <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                  <div className='ps-2'>
                    <h6><span><i class="fa-sharp fa-solid fa-location-dot"></i></span> Address : Calicut, Kerala </h6>
                  </div>
                </ListGroupItem>

                <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                <div className='ps-2'>
                    <h6><span><i class="fa-regular fa-envelope"></i></span> Email : Zehra.n@gmail.com </h6>
                  </div>
                </ListGroupItem>

                <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                <div className='ps-2'>
                    <h6><span><i class="fa-solid fa-phone"></i></span> Phone : +919644505364 </h6>
                  </div>
                </ListGroupItem>
              </ListGroup>
            </Col>
